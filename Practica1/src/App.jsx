...
let watchList = [
  ...
  return (
    <div>
      <h1>Peliculas de Nolan</h1>
      <div>{watchList.filter((movie)=> movie.Director === 'Christopher Nolan').map((movie)=>(
        <Filter
        key={movie.imdbID}
        nameMovie={movie.Title}
        />
      ))}</div>
      <h1>Peliculas de raitin mayor a 8</h1>
      <div>{watchList.filter((movie)=> movie.imdbRating >8).map((movie)=>(
        <Filter
        key={movie.imdbID}
        nameMovie={movie.Title}
        />
